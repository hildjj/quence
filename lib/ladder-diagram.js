...
exports.draw = function(diag) {
  ...
  function draw_arrow(parent, e1, e2, str, double_headed) {
    ...
    if (double_headed) {
        text_anchor = midpoint(e1, e2).adjust(0, diag.props.label_space_y);
        text_align = "middle";
    }
  ...
  function draw_self_arrow(parent, e1, e2, str, double_headed) {
    draw_line(parent, e1.col, e1.tm, e1.col+0.25, e1.tm);
    draw_line(parent, e1.col+0.25, e1.tm, e1.col+0.25, e2.tm);
    draw_line(parent, e1.col+0.25, e2.tm, e1.col, e2.tm);
    arrow_head(parent, 0, pos(e2), 1);
    ...
    if (str) {
      ...
      var text_anchor = pos(e1.col+0.25, (e1.tm+e2.tm)/2)
        .adjust(diag.props.label_space_x, -diag.props.label_space_y);
      text_anchor.att(txt);
    }
  }
