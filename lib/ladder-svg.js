...
SVGDriver.prototype.meta = function meta() {
...
SVGDriver.prototype.draw = function draw(cb) {
  ...
  /*
  this.marker(defs, "startMarker", 0, "M 10 0 L 0 5 L 10 10 L 9 5 Z", "closed");
  this.marker(defs, "endMarker", 10, "M 0 0 L 10 5 L 0 10 L 1 5 Z", "closed");
  this.marker(defs, "startMarkerOpen", 0, "M 10 0 L 0 5 L 10 10", "open");
  this.marker(defs, "endMarkerOpen", 10, "M 0 0 L 10 5 L 0 10", "open");
*/
  // TODO: move into the superclass somehow
  ...
  fs.readFile(__dirname + "/svg.css", {encoding: 'utf8'}, function(er, data) {
    ...
    var css = data.replace(/\[([^\]]+)]/g, function(m, p1) {
      return that.props[p1];
    });
