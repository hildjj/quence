...
function peg$parse(input, options) {
  ...
  var peg$e41 = peg$otherExpectation("required whitespace");
  ...
  var peg$f31 = function(s, c) { return [s, ...c].join('') };
  var peg$f32 = function(w) { return /[$_\p{ID_Start}]/u.test(w) };
  var peg$f33 = function(w) {
  ...
  var peg$f36 = function(num) { return parseInt(num, 10); };
