...
function peg$parse(input, options) {
  ...
  var peg$e3 = peg$literalExpectation("advance", false);
  var peg$e4 = peg$literalExpectation("loop", false);
  var peg$e5 = peg$literalExpectation("opt", false);
  ...
  var peg$e29 = peg$otherExpectation("optional whitespace");
  ...
  var peg$f4 = function(n) { diag.addAdvance(location().start.line, n); };
  var peg$f5 = function(tm, from, op, to, msg, opts) {
      diag.addMessage(location().start.line, tm, from, op, to, msg, opts);
  };
  var peg$f6 = function(p) { diag.addBlock(location().start.line, "loop", p); };
  var peg$f7 = function(p) { diag.addBlock(location().start.line, "opt", p); };
  var peg$f8 = function() { diag.endBlock(location().start.line); };
  var peg$f9 = function(w, val) {return val;};
  var peg$f10 = function(w, val) { diag.setProp(w, val); };
  var peg$f11 = function(w) { return w; };
  var peg$f12 = function(nm, t) { return diag.addEndpoint(nm, t); };
  var peg$f13 = function(nw) { return nw; };
  var peg$f14 = function() {return true;};
  var peg$f15 = function() {return false;};
  var peg$f16 = function(p) { return p.join(''); };
  ...
  var peg$f20 = function(first, o) {return o;};
  ...
  var peg$f22 = function(name, v) {return v;};
  var peg$f23 = function(name, val) {
    return [name, (val === '') ? true : val];
  };
  var peg$f24 = function(chars) {
    return chars.join('');
  };
  var peg$f25 = function(info) { return info.join(''); };
  var peg$f26 = function(chars) { return chars.join('').trim(); };
  var peg$f27 = function(num) { return parseInt(num.join(''), 10); };
