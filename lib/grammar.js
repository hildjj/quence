...
function peg$parse(input, options) {
  ...
  var peg$f20 = function(name, val) {
    return [name, (val === '') ? true : val];
  };
  var peg$f21 = function(num) { return parseInt(num, 10); };
