...
function peg$parse(input, options) {
  ...
  var peg$f18 = function(name, val) {
    return [name, (val === '') ? true : val];
  };
  var peg$f19 = function(num) { return parseInt(num, 10); };
