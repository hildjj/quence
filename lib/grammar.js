...
function peg$parse(input, options) {
  ...
  var peg$e7 = peg$literalExpectation("block", false);
  var peg$e8 = peg$literalExpectation("end", false);
  var peg$e9 = peg$literalExpectation("set", false);
  ...
  var peg$f9 = function(p) { diag.addBlock(location().start.line, "simple", p); };
  var peg$f10 = function() { diag.endBlock(location().start.line); };
  var peg$f11 = function(w, val) {
    diag.setProp(w, val);
  };
  var peg$f12 = function(w) {
    if (!diag.validProp(w)) {
  ...
  var peg$f13 = function(nm, t) { return diag.addEndpoint(nm, t); };
  ...
  var peg$f18 = function(dash, right_arr) {
    return new ast.Arrow(null, dash, '#')
  };
  var peg$f19 = function(left_arr, dash, right_arr) {
    return new ast.Arrow(left_arr, dash, right_arr);
  };
  var peg$f20 = function() { return null };
  var peg$f21 = function(first, follow) {
    const opts = {};
  ...
  var peg$f22 = function(name, val) {
    return [name, (val === '') ? true : val];
  };
  var peg$f23 = function(n) { return n.join('') };
  var peg$f24 = function(q) { return q.join('') };
  ...
  var peg$f29 = function(s, c) { return [s, ...c].join('') };
  var peg$f30 = function(w) { return /[$_\p{ID_Start}]/u.test(w) };
  var peg$f31 = function(w) {
  ...
  var peg$f34 = function(num) { return parseInt(num, 10); };
