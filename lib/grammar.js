...
function peg$parse(input, options) {
  ...
  var peg$f4 = function(ep, msg) { diag.addNote(location(), ep, msg); };
  ...
  var peg$f18 = function(first, follow) {
    const opts = {};
  ...
  var peg$f19 = function(name, val) {
    return [name, (val === '') ? true : val];
  };
  var peg$f20 = function(num) { return parseInt(num, 10); };
