...
function peg$parse(input, options) {
  ...
  var peg$f17 = function(name, val) {
    return [name, (val === '') ? true : val];
  };
  var peg$f18 = function(num) { return parseInt(num, 10); };
