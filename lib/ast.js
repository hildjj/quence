...
Message.prototype.compute = function(diag) {
  ...
  diag.moveTime(this.from.tm, this.to.tm, this.opts.advance);
};
...
Diagram.prototype.addMessage = function(line, tm, from, arrow, to, msg, opts) {
  return this.addStep(new Message(line, tm, from, arrow, to, msg, opts));
};
...
Diagram.prototype.moveTime = function(start, end, increment) {
