...
const BLOCK = (exports.BLOCK = 'BLOCK')
const END_BLOCK = (exports.END_BLOCK = 'END_BLOCK')
...
class Participants {
  ...
  forEach(func, that) {
    this.list.forEach(function(...args) {
...
exports.Diagram = class Diagram {
  ...
  addTime(tm) {
    ...
    const t = (this.timepoints[tm] = this.current_time)
    return t
  }
